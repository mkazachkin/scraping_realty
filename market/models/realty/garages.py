...
class TOffersGarages(BaseModel):
    """
    Класс модели предложений гаражей на сайтах продажи недвижимости
    """
    def __init__(self, is_commercial=False):
        self.is_commercial = is_commercial
        table_name = configuration.TABLES_CONFIG.get('garages_characteristics')
        self._garage_id = {
            'name': 'garage_id',
            'convertor': to_uuid,
            'key_field': True,
    ...
    def garage_type(self):
        return self._garage_type.get('name')
