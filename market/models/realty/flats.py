...
class TOffersFlats (BaseModel):
    """
    Класс модели предложений квартир на сайтах продажи недвижимости
    """
    def __init__(self, is_commercial=False):
        self.is_commercial = is_commercial
        table_name = configuration.TABLES_CONFIG.get('flats_characteristics')
        self._flat_id = {
            'name': 'flat_id',
            'convertor': to_uuid,
            'key_field': True,
